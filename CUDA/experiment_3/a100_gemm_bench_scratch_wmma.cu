...
// v1.4.1: 4x6 WARP_TILES (64x96 block, 768 threads)
static constexpr int TILE_M = 16;
static constexpr int TILE_N = 16;
static constexpr int TILE_K = 16;
static constexpr int WARPS_PER_BLOCK = 24;          // 24 warps = 768 threads
static constexpr int WARP_TILES_M = 4;              // 4 x 16 = 64 rows per block
static constexpr int WARP_TILES_N = 6;              // 6 x 16 = 96 cols per block
...
int main(int argc, char** argv) {
    ...
    std::printf("A100 GEMM benchmark (v1.4.1 - 4x6 WARP_TILES, 64x96 block)\n");
    ...
    dim3 block(32 * WARPS_PER_BLOCK, 1, 1); // 768 threads
